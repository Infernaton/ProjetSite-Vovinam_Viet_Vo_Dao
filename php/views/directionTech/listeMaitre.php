...
<div class="container">
        ...
        <div class="text-center mt-5">
            <h2 class="content-title-blue">Liste Officiel des Ceintures Noires et des Maîtres</h2>
        </div>
        <br>
        <p>
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-sm-4" data-toggle="modal" data-target="#myModal">
                    <img name="memb1" src="image.png" alt="membre 1">
                    <label for="memb1">Me .... ......</label>
                </div>
                <div class="col-sm-4" data-toggle="modal" data-target="#myModal">
                    <img name="memb2" src="image.png" alt="membre 2">
                    <label for="memb2">Me .... ......</label>
                </div>
                <div class="col-sm-4" data-toggle="modal" data-target="#myModal">
                    <img name="memb3" src="image.png" alt="membre 3">
                    <label for="memb3">Me .... ......</label>
                </div>
                <div class="col-sm-4" data-toggle="modal" data-target="#myModal">
                    <img name="memb4" src="image.png" alt="membre 4">
                    <label for="memb4">Me .... ......</label>
                </div>
                <div class="col-sm-4" data-toggle="modal" data-target="#myModal">
                    <img name="memb5" src="image.png" alt="membre 5">
                    <label for="memb5">Me .... ......</label>
                </div>
            </div>
        </div>
        <div class="">
