...
<?php 
    ...
    $listClub = $bdd->getClubForMap();
    $listComite = $bdd->getComiteForMap();
?>
<style>
    .tooltip-inner {
    ...
    <div class="text-center" id="comite">
        ...
        <div class="row">
            ...
            foreach ($listComite as $comite){
                $tooltipContent = "<p>Président de ce Comité : <br><strong>".$comite["president"]."</strong><br> (Contact: ".$comite["mail_pres"].")</p>".
                                "<p>Responsable Technique : <br><strong>".$comite["repTechnique"]."</strong><br> (Contact: ".$comite["mail_rt"].")</p>";
                ?>
                    <button class="col-12 col-sm-6 col-md-4 btn clickable" 
                        onClick='selectClub(["<?php echo $comite['id'].'","'.$comite['nomComite']?>"])'
                        data-toggle="tooltip" title='<?php echo $tooltipContent?>'>
                        <h4><strong>Comité <?php echo $comite['nomComite']?> </strong></h4>
                        <p> Site web: <a href='<?php echo $comite['link']?>' target='_blank' style=color:#e82226;>
                            <?php 
                            $printLien = '';
                            strlen($comite['link']) < 25? $count=strlen($comite['link']):$count=25;
                            for($i=0;$i<$count;$i++){
                                $printLien .= $comite['link'][$i];
                            }
                ...
                <div class="club col-12 col-sm-6 col-md-4 clickable" 
                    data-toggle="tooltip" title='<?php echo $tooltipClub?>'>
                        <div class="m-1">
                            ...
                            <p class="hide comite"> <?php echo $club['comiteId']?></p>
                        </div>
                </div>
                <?php
            }
                            ...
                            'features': [
                                ...
                                foreach ($listComite as $comite){
                                    ...
                                    if (count($coo) > 1){ ?>
                                        ...
                                        'properties': {
                                            'description':
                                                "<h4><strong>Comité <?php echo $comite['nomComite']?> </strong></h4>Site web: <a href='<?php echo $comite['link']?>' target='_blank' style=color:#e82226;><?php echo $comite['link'] ?></a> <hr>"+
                                                "<p>Président de ce Comité : <br><strong><?php echo $comite["president"]?></strong><br> (Contact: <?php echo $comite["mail_pres"] ?>)</p> <hr>" +
                                                "<p>Responsable Technique : <br><strong><?php echo $comite["repTechnique"] ?></strong><br> (Contact: <?php echo $comite["mail_rt"] ?>)</p>",
                                            },
                                        'geometry': {
                                            'type': 'Point',
