...
$histoire = ['
    {
        "id":0,
        "title":"Description radide et Introduction historique",
        "content1": [
            "/groupe_fondateur.jpg"
        ],
        "content2": [
            ...
            "Etablir une date de naissance pour l\'art martial, le « Vo » en vietnamien, est impossible. Cependant, c\'est sous le règne de l\'empereur Hùng Vuong 1er, il y a <b> 5000 ans</b> de cela, que les techniques de combat commencent à se développer.",
    ...
    '{
        "id":1,
        "title": "Les débuts, 1288 au XVIIIème siècle",
        "content1": [
            "/groupe_fondateur.jpg"
        ],
        "content2": [
    ...
    '{
        "id":2,
        "title": "XIXème et XXème siècle, les Colonies Françaises et la 1ère école",
        "content1": [
            "/groupe_fondateur.jpg"
        ],
        "content2": [
    ...
    '{
        "id":3,
        "title": "Les années 70, la Naissance de la fédération en France",
        "content1": [
            "/groupe_fondateur.jpg"
        ],
        "content2": [
            ...
            "Face à cette situation, beaucoup de personnes s\'expatrient, et parmi elles, certains de nos Maîtres.L\'un d\'entre eux arrive à Limoges (région Limousin) au tout début des années 1970. Il s\'agit de Maître PHAN HOANG. Peu à peu, d\'autres Maîtres le suivent.",
    ...
    '{
        "id":4,
        "title": "1980 à nos jours ...",
        "content1": [
            "/groupe_fondateur.jpg"
        ],
        "content2": [
            "Celle-ci, jusqu\'à aujourd\'hui s\'ests\'est développée et a formé de nombreux Maîtres, comme par exemple en Limousin, Me Ba Minh et Me Ha Kim Chung, qui ont fait partie de la première génération des Maîtres formés en France.",
            ...
            "Avec les résultats obtenus au cours des 25 dernières années, le Võvinam Viet Võ Dao a été introduit officiellementpar le Comité des sports du Vietnam, au contenu officiel des compétitions à l\'occasion du 4e Festival National des Sports en 2002. Cet événement résulte des sacrifices, du dépassement des difficultés de l\'ensemble des Maîtres, des entraîneurs et disciples du Võvinam dans tout le pays, sous la direction de la branche des sports."
        ]
    }',
    '{
        "id":5,
        ...
        "content1": [
            "/groupe_fondateur.jpg",
            "Par cette présence, il contribue à l\'unification de l\'Homme, au partage et à la connaissance de son prochain.<br>Au-delà du temps, le Võvinam Viet Võ Dao fidèle à son idéal, la formation de l\'Homme vrai, reflète le passé de nos aînés, le présent de nos Maîtres et l\'avenir de nos élèves."
        ],
        "content2": [
